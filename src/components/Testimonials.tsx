...
const GlobalSpotlight = ({
    ...
    useEffect(() => {
        ...
        spotlight.className = 'global-spotlight-testimonials';
...
export default function Testimonials() {
    ...
    return (
        <section className={styles.testimonialSection} id="testimonials" ref={sectionRef}>
            <GlobalSpotlight
                            ...
                            >
                                <div className={styles.cardHeader}>
                                    ...
                                    <div className={styles.authorInfo}>
                                        <div className={styles.author}>{t(`items.${index}.name`)}</div>
                                        <div className={styles.role}>{t(`items.${index}.role`)}</div>
                                    </div>
                                </div>
